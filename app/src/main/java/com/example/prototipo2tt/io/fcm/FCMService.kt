package com.example.prototipo2tt.io.fcm
...
class FCMService : FirebaseMessagingService() {
    ...
    override fun onNewToken(token: String) {
        ...
        val call = apiService.postTokenStudent(authHeader, token)
        call.enqueue(object : Callback<Void> {
            ...
            override fun onFailure(call: Call<Void>, t: Throwable) {
                Toast.makeText(this@FCMService, t.localizedMessage, Toast.LENGTH_SHORT).show()
            }
