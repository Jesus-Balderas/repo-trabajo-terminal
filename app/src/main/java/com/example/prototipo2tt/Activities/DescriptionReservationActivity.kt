...
class DescriptionReservationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnRefuseRervation.setOnClickListener{
            ...
            reservationRefusedId.text = getString(R.string.description_reservation_id, reservation.idReservation)
        ...
        if (intent.extras != null){
            ...
            reservationId.text = getString(R.string.description_reservation_id, reservation.idReservation)
